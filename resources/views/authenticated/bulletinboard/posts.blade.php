      ...
      <div class="post_bottom_area d-flex">
        <div class="d-flex post_status">
          ...
          <div>
            ...
            <p class="m-0"><i class="fas fa-heart un_like_btn" post_id="{{ $post->id }}"></i><span class="pl-2 like_counts{{ $post->id }}">{{ $likes->likeCounts($post->id) }}</span></p>
            @else
            <p class="m-0"><i class="fas fa-heart like_btn" post_id="{{ $post->id }}"></i><span class="pl-2 like_counts{{ $post->id }}">{{ $likes->likeCounts($post->id) }}</span></p>
            @endif
          </div>
        </div>
      </div>
